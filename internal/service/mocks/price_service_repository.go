...
import (
	...
	proto_services "github.com/distuurbia/PriceService/proto_services"
)
...
// SendToSubscriber provides a mock function with given fields: protoShares, stream
func (_m *PriceServiceRepository) SendToSubscriber(protoShares []*proto_services.Share, stream proto_services.PriceServiceService_SubscribeServer) error {
	ret := _m.Called(protoShares, stream)

	var r0 error
	if rf, ok := ret.Get(0).(func([]*proto_services.Share, proto_services.PriceServiceService_SubscribeServer) error); ok {
		r0 = rf(protoShares, stream)
	} else {
		r0 = ret.Error(0)
	}
